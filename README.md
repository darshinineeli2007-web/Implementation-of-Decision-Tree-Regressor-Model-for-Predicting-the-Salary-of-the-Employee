...
## Algorithm
1.Import required libraries like NumPy, Pandas, and Decision Tree Regressor from Scikit-learn.
2.Load the employee dataset and separate features and salary values.
3.Train the Decision Tree Regressor model using the training data. 
4.Use the trained model to predict the employee salary. 
...
## Output:
<img width="853" height="722" alt="image" src="https://github.com/user-attachments/assets/2015bd97-de21-4f89-9430-76bdc9472e00" />
